...
cp -R "/n/holystore01/LABS/pehlevan_lab/Users/sab/cifar-10-batches-py" /tmp/2/data-dir

mkdir /tmp/2/results

cp -R /n/home07/ssainathan/workplace/gpu_scheduler /tmp/2
cd /tmp/2/gpu_scheduler

rm conf/config.yaml

printf "defaults:\n  - experiment: sweep_2" > conf/config.yaml
