...
mkdir /tmp/512/data-dir

mkdir /tmp/512/results

cp -R /n/home07/ssainathan/workplace/gpu_scheduler /tmp/512
cd /tmp/512/gpu_scheduler

rm conf/config.yaml

printf "defaults:\n  - experiment: sweep_width_512" > conf/config.yaml
