...
mkdir /tmp/31/data-dir
cp -R "/n/holystore01/LABS/pehlevan_lab/Users/sab/cifar-10-batches-py" /tmp/31/data-dir

mkdir /tmp/31/results

cp -R /n/home07/ssainathan/workplace/gpu_scheduler /tmp/31
cd /tmp/31/gpu_scheduler

rm conf/config.yaml

printf "defaults:\n  - experiment: sweep_31" > conf/config.yaml
