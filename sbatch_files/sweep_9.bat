...
mkdir /tmp/9/data-dir
cp -R "/n/holystore01/LABS/pehlevan_lab/Users/sab/cifar-10-batches-py" /tmp/9/data-dir

mkdir /tmp/9/results

cp -R /n/home07/ssainathan/workplace/gpu_scheduler /tmp/9
cd /tmp/9/gpu_scheduler

rm conf/config.yaml

printf "defaults:\n  - experiment: sweep_9" > conf/config.yaml
